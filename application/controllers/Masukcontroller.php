...
class Masukcontroller extends CI_Controller {
	...
	public function registration()
	{
		...
		$this->form_validation->set_rules('password1', 'Password', 'required|trim|min_length[3]|matches[password2]',['matches'=> 'Password dont match!','min_length' => 'Password terlalu pendek!']);
