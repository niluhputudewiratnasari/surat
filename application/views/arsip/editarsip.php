			...
			<div class="card">
				<div class="card-body">
					<form action="<?= site_url('arsip/proses_simpan') ?>" method="post">
						<div class="row mb-3">
							<input type="hidden" class="form-control" id="id_arsipmasuk" name="id_arsipmasuk" value="<?= $nomor_surat['id_arsipmasuk']; ?>">
							<?= form_error('id_arsipmasuk','<small class="text-danger pl-3">', '</small>');  ?>

						</div>
						<div class="row mb-3">
							<label for="tgl_arsipmasuk" class="col-sm-2 col-form-label">Tanggal Arsip Masuk</label>
							<div class="col-sm-10">
								<input type="date" class="form-control" id="tgl_arsipmasuk" name="tgl_arsipmasuk"value="<?= $nomor_surat['tgl_arsipmasuk']; ?>">
