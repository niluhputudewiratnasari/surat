				...
				<div class="row">
					<div class="col-lg">
						...
						<form action="<?= site_url('arsip/proses_editar') ?>" method="post">
							...
							<div class="row mb-3">
								<label for="no" class="col-sm-3 col-form-label">Nomor Arsip</label>
								<div class="col-sm-8">
							...
							<div class="row mb-3">
								<label for="tgl_arsipkeluar" class="col-sm-3 col-form-label">Tanggal Arsip Masuk</label>
								<div class="col-sm-8">
									<input type="date" class="form-control" required id="tgl_arsipmasuk" name="tgl_arsipmasuk" placeholder="Masukkan Tanggal Arsip Masuk"  value="<?= $nomor_surat['tgl_arsipmasuk']; ?>"> 
							...
							<div class="form-group row justify-content-end">
								<div class="col-sm-9">
									...
									<a class="btn btn-danger" href="<?=site_url('Arsip/index')?>" role="button">Batal</a>
								</div>
							</div>
