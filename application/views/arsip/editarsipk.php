				...
				<div class="row">
					<div class="col-lg">
						...
						<form action="<?= site_url('arsip/proses_editark') ?>" method="post">
							...
							<div class="row mb-3">
								<label for="no" class="col-sm-3 col-form-label">No. Arsip</label>
								<div class="col-sm-8">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-8">
									<input type="date" class="form-control" required id="tgl_arsipkeluar" name="tgl_arsipkeluar" placeholder="Masukkan Tanggal Arsip Masuk"  value="<?= $nomor_surat['tgl_arsipkeluar']; ?>"> 
							...
							<div class="form-group row justify-content-end">
								<div class="col-sm-9">
									...
									<a class="btn btn-danger" href="<?=site_url('Arsip/arsipkeluar')?>" role="button">Batal</a>
								</div>
							</div>
