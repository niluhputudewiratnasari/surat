    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="date" class="form-control" id="tgl_arsipkeluar" name="tgl_arsipkeluar">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="kepada" name="kepada" placeholder="Masukkan nomor surat"  value="<?= $nomor_surat['kepada']; ?>">
          </div>
