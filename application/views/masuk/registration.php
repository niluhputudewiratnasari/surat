            ...
            <div class="row">
                <div class="col-lg">
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('masukcontroller/registration')  ?>">
                        ...
                        <div class="text-center">
                            <a class="small" href="<?= base_url('masukcontroller'); ?>">Sudah memiliki akun? Silahkan Login!</a>
                        </div>
                    </div>
                </div>
            </div>
