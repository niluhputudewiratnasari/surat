					...
					<div class="col-lg-8">
						...
						<form action="<?= site_url('menu/proses_editklasifikasi') ?>" method="post">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" required id="nama_klasifikasi" name="nama_klasifikasi" placeholder="Masukkan Nama Klasifikasi"  value="<?= $kode_klasifikasi['nama_klasifikasi']; ?>"> 
							...
							<div class="row mb-3">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" required id="uraian" name="uraian" placeholder="Masukkan Uraian"  value="<?= $kode_klasifikasi['uraian']; ?>">
							...
							<div class="form-group row justify-content-end">
								<div class="col-sm-9">
									...
									<a class="btn btn-danger" href="<?=site_url('Menu/klasifikasi')?>" role="button">Batal</a>
								</div>
							</div>
